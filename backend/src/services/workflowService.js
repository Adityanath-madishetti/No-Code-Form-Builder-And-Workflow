...
export async function transitionSubmissionService(formId, submissionId, transitionId, requestRole, userToken) {
...
export async function listAvailableTransitionsService(formId, submissionId, requestRole, userToken) {
    const form = await Form.findOne({ formId, isDeleted: false });
    if (!form) throw createError(404, "Form not found");
