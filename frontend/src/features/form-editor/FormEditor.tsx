...
} from '@/features/form/utils/componentRegistry';
import { useFormDragHandlers } from '@/features/form/hooks/useFormDragHandlers';
import {
  DRAG_CATALOG_COMPONENT_ID,
  DRAG_COMPONENT_ID,
  DRAG_CATALOG_PAGE_ID,
  DRAG_CATALOG_GROUP_ID,
} from '@/features/form/utils/DndUtils';
...
import { useFormEditorShortcuts } from './hooks/useFormEditorShortcuts';
    ...
    >
      <div className="isolate flex h-screen w-full overflow-hidden bg-neutral-50 dark:bg-neutral-950">
        <div className="relative flex h-full flex-1 overflow-hidden">
          ...
          <div className="fixed bottom-4 left-4 z-[600000] flex gap-1 will-change-transform">
            <button
              onClick={() => navigate('/')}
